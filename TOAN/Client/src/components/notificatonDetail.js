...
import { Row, Col, Card, CardBody, Button, Modal, ModalHeader, ModalBody, ModalFooter, Alert } from 'reactstrap';
    ...
    return (
        <Modal
            ...
            <ModalBody>
                ...
                <small className="text-muted mt-4" >{dateToString(props.content.updatedAt)}</small>
            </ModalBody>
            <ModalFooter className='text-right'>
                {
                    (props.content.type ==='Access-Invite')?(
                        ...
                        <>
                            <Button color='danger' onClick={props.deleteAction}>Xóa thông báo</Button>
                            <Button color="secondary" className="ml-1" onClick={props.toggle}>Đóng</Button>
                        </>
                    )
                }
            </ModalFooter>

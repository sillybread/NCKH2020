            ...
            <Row>
                <Col md={6} xl={3}>
                    <StatisticsProgressWidget
                        ...
                        color="primary"
                        progressValue="32"
                        progressTitle="36% Avg"></StatisticsProgressWidget>
                </Col>
                <Col md={6} xl={3}>
                    <StatisticsProgressWidget
                        description="Product Sold"
                        ...
                        color="warning"
                        progressValue="60"
                        progressTitle="36 Daily Avg"></StatisticsProgressWidget>
                </Col>
                <Col md={6} xl={3}>
                    <StatisticsProgressWidget
                        description="New Customers"
                        ...
                        color="success"
                        progressValue="45"
                        progressTitle="3 Daily Avg"></StatisticsProgressWidget>
                </Col>
                <Col md={6} xl={3}>
                    <StatisticsProgressWidget
                        description="New Visitors"
                        ...
                        color="success"
                        progressValue="67"
                        progressTitle="300 Daily Avg"></StatisticsProgressWidget>
                </Col>
            </Row>

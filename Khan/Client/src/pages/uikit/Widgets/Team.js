                        ...
                        <ul className="list-unstyled ml-sm-3 pl-sm-5 mt-4 mt-sm-0">
                            <li className="mb-4">
                                <p className="text-muted mb-0 font-size-13">
                                    <i className="uil uil-calender mr-1"></i>7:30 AM - 10:00 AM
                                </p>
                                <h6 className="mt-1 font-size-16">UX Planning Meeting</h6>
                            </li>
                            <li className="mb-4">
                                <p className="text-muted mb-0 font-size-13">
                                    <i className="uil uil-calender mr-1"></i>10:30 AM - 11:45 AM
                                </p>
                                <h6 className="mt-1 font-size-16">Hyper v3 Scope Review</h6>
                            </li>
                            <li className="mb-4">
                                <p className="text-muted mb-0 font-size-13">
                                    <i className="uil uil-calender mr-1"></i>12:15 PM - 02:00 PM
                                </p>
                                <h6 className="mt-1 font-size-16">Ubold v4 Brainstorming</h6>
                            </li>
                            <li className="mb-4">
                                <p className="text-muted mb-0 font-size-13">
                                    <i className="uil uil-calender mr-1"></i>5:30 PM - 06:15 PM
                                </p>
                                <h6 className="mt-1 font-size-16">Shreyu React Planning</h6>
                            </li>
                            <li>
                                <a href="/" className="btn btn-primary btn-block w-75 mb-0">
                                    <i className="uil uil-focus-add mr-2"></i>Add Event
                                </a>
                            </li>
                        </ul>
                    </Col>
...
const Chat = () => {
    ...
    return <ChatList messages={chatMessages} height="268px"></ChatList>;
};
...
const Activity = () => (
    <Card>
        <CardBody className="pt-2 pb-3">
            ...
            <Media className="mt-5">
                ...
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        ...
                        has attached design-draft.sketch in project{' '}
                        <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
            ...
            <Media className="mt-3">
                ...
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        ...
                        has commented on project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
            ...
            <Media className="mt-3">
                ...
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        ...
                        has reacted with <i className="uil uil-thumbs-up text-success font-size-13"></i> on comment from{' '}
                        <span className="font-weight-bold text-primary">Shreyu</span> on project{' '}
                        <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
            ...
            <Media className="mt-3">
                <div className="avatar mr-3 font-size-24 font-weight-normal">
                    <span className="avatar-title rounded-circle bg-soft-success text-success">D</span>
                </div>
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">
                        ...
                        has reacted with <i className="uil uil-heart-sign text-danger font-size-13"></i> on comment from{' '}
                        <span className="font-weight-bold text-primary">Shreyu</span> on project{' '}
                        <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
                    <p className="text-muted">14 Min Ago</p>
